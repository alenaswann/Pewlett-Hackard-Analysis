...
-- Create table with filters for retiring employees info from employees, salaries, and dept_emp tables
SELECT e.emp_no,
		e.first_name, 
		e.last_name,
		e.gender,
...
--Tailored list of retiring sales employees
SELECT ce.emp_no,
ce.first_name,
ce.last_name,
d.dept_name
...
--Tailored list of retiring Sales and Development employees
SELECT ce.emp_no,
ce.first_name,
ce.last_name,
d.dept_name
